...
It scans Claude Code, Codex, Cursor, Cherry Studio, Alma, DeepChat, OpenCode, and related tools, then explains disk usage, sessions, caches, logs, traces, SQLite/LevelDB state, and cleanup risk before anything is removed.
...
4. [CLI Spec](./03-cli-spec.md) defines `vhaul` commands, flags, outputs, and UX rules.
